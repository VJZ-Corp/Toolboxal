...
<h2>Contributing</h2>
The details of contributing are highlighted in "CONTRIBUTING.md" in the project's root directory. Please follow the contributing guidelines strictly as any abusers will be withholded the opportunity to contribute. "CONTRIBUTING.md" can also be found here @ https://github.com/VJZ-Corp/Toolboxal/blob/master/CONTRIBUTING.md.
